...
DESCRIPTION="Examine WEKA stats for quota impact"
SCRIPT_TYPE="single"
INTERNAL_REFERENCE="WEKAPP-XXXXX"
CLUSTER_TESTS["ops_driver/READ_LATENCY"]="average:more_than:10ms:-2m"
CLUSTER_TESTS["rpc/CLIENT_ROUNDTRIP_AVG"]="individual:less_than:10ms:-2m"
CLUSTER_TESTS["rpc/SERVER_PROCESSING_AVG"]="individual:less_than:1ms:-2m"
DRIVE_TESTS["ssd/SSD_READ_LATENCY"]="individual:less_than:1ms:-2m"
DRIVE_TESTS["ssd/DRIVE_READ_LATENCY"]="individual:less_than:1ms:-2m"
DRIVE_TESTS["ssd/DRIVE_UTILIZATION"]="individual:less_than:90:-2m"
DRIVE_TESTS["ssd/DRIVE_LOAD"]="individual:less_than:250:-2m"
CLUSTER_TESTS["DRIVE_READ_RATIO_PER_SSD_READ"]="average:more_than:5:-2m"
DRIVE_TESTS["ssd/DRIVE_IO_TOO_LONG"]="individual:less_than:700:-2m"
